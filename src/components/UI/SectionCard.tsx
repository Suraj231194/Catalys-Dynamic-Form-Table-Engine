...
export function SectionCard({ title, subtitle, icon, children }: SectionCardProps) {
  return (
    <section className="rounded-2xl border border-surface-800/80 dark:border-surface-800/70 bg-surface-950/40 dark:bg-surface-900/50 backdrop-blur-md p-4 sm:p-6 md:p-8 shadow-xl shadow-surface-950/5 dark:shadow-black/20 transition-all duration-300 hover:border-primary-500/30">
